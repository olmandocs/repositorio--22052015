$(document).on('pagecreate', '#home', function(){ //creación del home
...
/* Capture Audio */
$(document).on('pagecreate', '#audio', function(){//creación del audio
  ...
  $('#button-audio').bind('click', function(event){
    ...
    navigator.device.capture.captureAudio(onCaptureAudioSuccess, onCaptureAudioError, {duration: duration, limit: num_items});//exitoso, fallido,{duracion, numero de items}
...
/* Capture Camera */
$(document).on('pagecreate', '#camera', function(){//creación del camera
  ...
  $('#button-camera').bind('click', function(event){
    ...
    navigator.device.capture.captureImage( onCaptureImageSuccess, onCaptureImageError, {limit: num_items});//exitoso, fallido,{numero de items}
...
/* Capture Video */
$(document).on('pagecreate', '#video', function(){ //creación del video
  ...
  $('#button-video').bind('click', function(event){
    ...
    navigator.device.capture.captureVideo(onCaptureVideoSuccess, onCaptureVideoError, {duration: duration, limit: num_items}); //exitoso, fallido,{duracion, numero de items}
